...
This repository contains an AI-powered agent system that automates key phases of the Software Development Lifecycle (SDLC), including cloning, building, reviewing, testing, and security scanning of source code.
